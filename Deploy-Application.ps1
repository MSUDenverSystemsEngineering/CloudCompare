...
[Diagnostics.CodeAnalysis.SuppressMessageAttribute("UseConsistentWhitespace", "", Justification = "This test is getting stuck in VSCode")]
Param (
...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'CloudCompare' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		If ( Test-Path "$envProgramFiles\CloudCompare") {
			Execute-Process -Path "C:\Program Files\CloudCompare\unins000.exe" -Parameters "/VERYSILENT"
		}
		elseif ( Test-Path "$envProgramFiles\CloudCompareStereo\") {
			...
			## Remove Desktop Link
			If (Test-Path "$env:Public\Desktop\CloudCompare.lnk") {
				Remove-Item "$env:Public\Desktop\CloudCompare.lnk" -Force
			}
		}
		ElseIf ($deploymentType -ieq 'Uninstall') {
			...
			Show-InstallationWelcome -CloseApps 'CloudCompare' -CloseAppsCountdown 60
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCaTxYBi+N3CoNx
# xHxdveamZNCtA4GCEv4GcYPdKWJP9qCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgCmzSxxAFYBDI
# 40LUyrQ2q6R/Qcda/CS4oX63DVnjJiQwDQYJKoZIhvcNAQEBBQAEggGAhEYXSQAq
# eM55RO68MjQkvbH+U8pIGHpL4Tg9SmjwT6xAXWVQNzCjGDb+zCRP5SJa3keEfyHf
# v8Uzx/XSlm94NczUI7QmfvTsNek3j5XYNy4pW/8/IXhjiq23Il8D17JaVXzvRxU/
# 55WH2pWloDp+QuH49G9Gz+gE8pRI3Z0Je2CWewmw+wAhc5BV2ssCFN9Y/Oi8PlUz
# XjoEjoQfNnd+y+23ZSX2EJfVgOezHYVvoHrHC5YMShyJBj4kuALtBMO6xhP0a7yW
# uXhPPcmBb9nLtfLLKtcNFDytf2B740RciHWRWiXW62A5eZAcxP4CtX2NbgyNJ8cA
# bMvVeC3++wKiA1QnHSpREsG2bPLgsdGvBdOQaQaj2xnNNwRD/mlKxNhwibjAftLo
# VjtO9kyqEuJYkS6SDpsLzhFpSgi49mIC1YgCIV3XfRS+GuQ8ndwqtQEOCvprQMO1
# e0wWoVVSIluPQiihp/IFuN0Vs7/EIMq4m6Jo2XjjIoiA8BDpYJaoOvEDoYIDTDCC
...
# MzUxNTdaMD8GCSqGSIb3DQEJBDEyBDCZNI8rpUb8IMJeUWyt3MO6C64ulpA4KIjq
# UX+5g8JHXblX76b7OShcgTi0gGKnO9EwDQYJKoZIhvcNAQEBBQAEggIAXgCWmZj+
# eIkvlBe/9rEwE9J8juFyi86aFr4IUFTuYsQwIgZz70n6Cf0UqeBOWB38oQSaMQrw
# IpNxyeRDurueqchFW4x/SXLCwZWgUOdy1CHBfiV4usg2cwlY10D4n91U3UaFnWm2
# ELrFRCYHpXLQaEnVDAyEf89Lz9YyImssf3QTlvmgQNZc9dgY00UQX8e6d6eljq+W
# 1QmXQWzalsaRysS7aa26Bb8sYgMBTsfw4WZd4j8Vj023B9OeLx1hxUYXxdbzANC1
# KVDwI2fl1ToxHjl/nGOQ93MzL8+zP9wDUJBHyXFcD4T0pVIpYZfuXGQuZpvxHuqL
# fZcJzhtTQlT6TYbraegSwQFmsDKnG6+EgYthPl5b7+Aj36RW41+lR7swPiCWwhPs
# w1rT0ACaqIvMO2aMD2nwYjU829S5FoFrogYEtjACeLjN4RJ1eAifxf5HNjchSjUl
# a1KcKKJEFMMmsGlWdkLWuRT5d8Vx7Z5Q9KJgwZPH3L17POQv1vNt6Nt3Q6X8E8Qt
# Dwo5oWh6KEPddX4mr9OSwQxY3m8EfpFqbVpJ1nuJxL2nWQepIyP/9GMnR/JSXqfH
# i9i+95b/v7DuIn3PSosanaQr0S/PkbSKKDByHsp95ciu0KUF3nNkHF+H/EyEy1Ir
# YqNDr0SCMITtAKglyjezLH6haTQnwGwEAz4=
